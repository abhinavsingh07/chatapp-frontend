...
public class EndpointRegistry {
    ...
    private final Map<String, ApiRequestBuilderUtil.ApiEndpoint> endpoints = Map.ofEntries(
            ...
            Map.entry("conv.getOrCreateConv", new ApiRequestBuilderUtil.ApiEndpoint("/api/conversations/get-or-create/{toUserId}", HttpMethod.POST)),
            Map.entry("conv.getLastConversationByLoggedInUser", new ApiRequestBuilderUtil.ApiEndpoint("/api/conversations/last-message", HttpMethod.GET)),
            ...
            Map.entry("contacts.getByUserId", new ApiRequestBuilderUtil.ApiEndpoint("/api/contacts", HttpMethod.GET)),
            ...
            Map.entry("media.getPresignedUrl", new ApiRequestBuilderUtil.ApiEndpoint("/api/media/pre-signed-url/{userId}/{mediaId}", HttpMethod.GET)),
