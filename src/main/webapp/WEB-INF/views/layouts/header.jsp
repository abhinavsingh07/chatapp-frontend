<%@ include file="/WEB-INF/views/common.jsp" %>
    ...
    <script>
        ...
        function sendInAppNotification(title, messageBody) {
            if (Notification.permission === "granted") {
                ...
                notification.onclick = () => {
                    window.focus();
                    window.location.href = "${pageContext.request.contextPath}/chat.jsp";
                };
            }
        }
            ...
            globalWorkerPort.onmessage = function (event) {
                ...
                if (messageType === 'CHAT_MESSAGE') {
                    ...
                    if (isChatPage) {
                        ...
                        sendInAppNotification("New message from " + (payload.sender || "User"), payload.message);
